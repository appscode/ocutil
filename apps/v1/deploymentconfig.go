...
func WaitUntilDeploymentConfigReady(c oc.Interface, meta metav1.ObjectMeta) error {
...
func DeleteDeploymentConfig(kc kubernetes.Interface, occ oc.Interface, meta metav1.ObjectMeta) error {
